/*
 * Author : undec
 * Created at 2024-04-06 23:35:01
...
int _solve() {
    ...
    // 1 2 3 4 100 5 6 101 7 8 9 102 >10<
    // 3 3 2 1  3  0 0 0 00 0 00 00 0
    // 1 2 3 4 5 6 100 7 101 8 9 102 >10<
    // 5 5 4 3 2 1  2  0 0 0 0 00 0 00 00 0
    // 1 2 3 4 5 6 100 7 8 9 >10< 101
    // 5 5 4 3 2 1  4  0 0 0 0 00 0 00 00 0
    auto wins = [](int k) {
        dbg(k);
        swap(A[k], A[K]);
        for (int i = 0; i < k; i++)
